module github.com/cjxpj/nebulaApk

go 1.26

require (
	github.com/cjxpj/nebula v0.0.0
...
require (
	...
	github.com/cjxpj/hajimimanbo v0.0.0-20250902210732-84be7d3299ad // indirect
...
replace github.com/cjxpj/nebula => ../nebula
