...
func Setup() {
	if err := Registers(
		...
		f{Name: "sqlite.删除文件", L: "2", Fn: sqliteDeleteFile},
		f{Name: "sqlite.删除文件夹", L: "2", Fn: sqliteDeleteDir},
		f{Name: "读.sqlite", L: "1|2|3", Fn: readSqlite},
		f{Name: "写.sqlite", L: "2|3", Fn: writeSqlite},
		f{Name: "关闭数据库", L: "1", Fn: dbClose},
		f{Name: "db.写", L: "1|2", Fn: dbWrite},
		f{Name: "db.读", L: "0|1|2", Fn: dbRead},
		f{Name: "db.删除", L: "2", Fn: dbDelete},
		f{Name: "db.删除文件", L: "1", Fn: dbDeleteFile},
		f{Name: "db.删除文件夹", L: "1", Fn: dbDeleteDir},
		...
		f{Name: "画笔.字体", L: "2", Fn: drawImgLoadFont},
		...
		f{Name: "绘制.文本", L: "4|5|6|7|8", Fn: drawImgText},
		f{Name: "绘制.点", L: "3|4", Fn: drawImgPoint},
		f{Name: "绘制.线", L: "5|6", Fn: drawImgLine},
		f{Name: "绘制.喷漆", L: "5|6|7|8|9", Fn: drawImgBrushLine},
		f{Name: "绘制.波浪", L: "5|6|7|8", Fn: drawImgWaveLine},
		f{Name: "绘制.油漆桶", L: "3|4", Fn: drawImgFloodFill},
		f{Name: "绘制.方形", L: "5|6|7", Fn: drawImgRectangleFill},
		f{Name: "绘制.方形描边", L: "5|6|7", Fn: drawImgRectangleStroke},
		f{Name: "绘制.椭圆", L: "5|6", Fn: drawImgEllipseFill},
		f{Name: "绘制.椭圆描边", L: "5|6", Fn: drawImgEllipse},
		f{Name: "绘制.圆形", L: "3|4|5|6|7", Fn: drawImgPieFill},
		f{Name: "绘制.圆形描边", L: "3|4|6|7", Fn: drawImgPie},
		f{Name: "绘制.多边形", L: "4..", Fn: drawImgPolygon},
		f{Name: "绘制.多边形描边", L: "3..", Fn: drawImgPolygons},
		f{Name: "绘制.图片", L: "2|3|4|5|6|7|8|9", Fn: drawImgPaste},
		f{Name: "绘制.圆弧", L: "6|7", Fn: drawImgArc},
		f{Name: "绘制.随机点", L: "1|2", Fn: drawImgRandomDots},
		f{Name: "绘制.随机线条", L: "1|2", Fn: drawImgRandomLines},
		f{Name: "画布.旋转", L: "2|3", Fn: drawImgRotate},
		f{Name: "画布.圆形", L: "1|2|3", Fn: drawImgRoundCorners},
		f{Name: "画布.灰度", L: "1", Fn: drawImgGrayscale},
		f{Name: "画布.马赛克", L: "1|2", Fn: drawImgAllMosaic},
		f{Name: "绘制.高斯模糊", L: "5", Fn: drawImgGaussianBlur},
		f{Name: "绘制.马赛克", L: "5", Fn: drawImgMosaic},
