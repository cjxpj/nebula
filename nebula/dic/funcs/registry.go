...
func Setup() {
	if err := Registers(
		...
		f{Name: "访问", List: []f{
			...
			{Name: "切换PUT", L: "1|2", Fn: changeRequestPut},
			{Name: "切换DELETE", L: "1|2", Fn: changeRequestDelete},
			{Name: "切换PATCH", L: "1|2", Fn: changeRequestPatch},
			{Name: "切换HEAD", L: "1", Fn: changeRequestHead},
			{Name: "切换OPTIONS", L: "1", Fn: changeRequestOptions},
